<?php
    namespace AHT\HelloWorld\Console\Command;
    ...
    { 
        ...
        protected function configure()
        {
            ...
            $this->setName('helloworld:info')->setDescription('Get info about installation')->setDefinition($options);
            parent::configure();
        }
        ...
        protected function execute(InputInterface $input, OutputInterface $output)
        {
            ...
            if ($input->getOption(self::INPUT_KEY_EXTENDED)) {
                $output->writeln('');$output->writeln('<info>'.'Extended parameter is given'.'</info>');
            }
            $output->writeln('');
        }
    }